...
class OrdersApi
{
     ...
     */
    public function searchSearch_1($model, string $contentType = self::contentTypes['searchSearch_1'][0])
    {
     ...
     */
    public function searchSearch_1WithHttpInfo($model, string $contentType = self::contentTypes['searchSearch_1'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchSearch_1Async($model, string $contentType = self::contentTypes['searchSearch_1'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchSearch_1AsyncWithHttpInfo($model, string $contentType = self::contentTypes['searchSearch_1'][0])
    {
        $returnType = '\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfRechnungsdruckWebAppControllersApiSearchControllerSearchResultsModel';
        $request = $this->searchSearch_1Request($model, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchSearch_1Request($model, string $contentType = self::contentTypes['searchSearch_1'][0])
    {
