...
class RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const DEFAULT_VAT_MODE_0 = 0;
    public const DEFAULT_VAT_MODE_1 = 1;
    public const DEFAULT_VAT_MODE_2 = 2;
    public const DEFAULT_VAT_MODE_3 = 3;
    public const DEFAULT_VAT_MODE_4 = 4;
    public const DEFAULT_VAT_MODE_5 = 5;
    ...
    {
        return [
            self::DEFAULT_VAT_MODE_0,
            self::DEFAULT_VAT_MODE_1,
            self::DEFAULT_VAT_MODE_2,
            self::DEFAULT_VAT_MODE_3,
            self::DEFAULT_VAT_MODE_4,
            self::DEFAULT_VAT_MODE_5,
        ];
    }
