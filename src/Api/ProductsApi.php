...
class ProductsApi
{
    ...
    public function articleCreateArticle(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelArticleApiModel $model,
        string $contentType = self::contentTypes['articleCreateArticle'][0]
    ): object
    {
     ...
     */
    public function articleCreateArticleWithHttpInfo(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelArticleApiModel $model,
        string $contentType = self::contentTypes['articleCreateArticle'][0]
    ): array
    {
     ...
     */
    public function articleCreateArticleAsync(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelArticleApiModel $model,
        string $contentType = self::contentTypes['articleCreateArticle'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleCreateArticleAsyncWithHttpInfo(
        $model,
        string $contentType = self::contentTypes['articleCreateArticle'][0]
    ): PromiseInterface
    {
     ...
     */
    public function articleCreateArticleRequest(
        $model,
        string $contentType = self::contentTypes['articleCreateArticle'][0]
    ): Request
    {
    ...
    public function articleDeleteArticle(
        int $id,
        string $contentType = self::contentTypes['articleDeleteArticle'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleDeleteArticleWithHttpInfo(
        int $id,
        string $contentType = self::contentTypes['articleDeleteArticle'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function articleDeleteArticleAsync(
        int $id,
        string $contentType = self::contentTypes['articleDeleteArticle'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleDeleteArticleAsyncWithHttpInfo(
        $id,
        string $contentType = self::contentTypes['articleDeleteArticle'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleDeleteArticleRequest(
        $id,
        string $contentType = self::contentTypes['articleDeleteArticle'][0]
    ): Request
    {
    ...
    public function articleDeleteImage(
        int $image_id,
        string $contentType = self::contentTypes['articleDeleteImage'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleDeleteImageWithHttpInfo(
        int $image_id,
        string $contentType = self::contentTypes['articleDeleteImage'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function articleDeleteImageAsync(
        int $image_id,
        string $contentType = self::contentTypes['articleDeleteImage'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleDeleteImageAsyncWithHttpInfo(
        $image_id,
        string $contentType = self::contentTypes['articleDeleteImage'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleDeleteImageRequest(
        $image_id,
        string $contentType = self::contentTypes['articleDeleteImage'][0]
    ): Request
    {
    ...
    public function articleDeleteImageFromProduct(
        int $product_id,
        int $image_id,
        string $contentType = self::contentTypes['articleDeleteImageFromProduct'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleDeleteImageFromProductWithHttpInfo(
        int $product_id,
        int $image_id,
        string $contentType = self::contentTypes['articleDeleteImageFromProduct'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function articleDeleteImageFromProductAsync(
        int $product_id,
        int $image_id,
        string $contentType = self::contentTypes['articleDeleteImageFromProduct'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function articleDeleteImageFromProductAsyncWithHttpInfo(
        $product_id,
        $image_id,
        string $contentType = self::contentTypes['articleDeleteImageFromProduct'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleDeleteImageFromProductRequest(
        $product_id,
        $image_id,
        string $contentType = self::contentTypes['articleDeleteImageFromProduct'][0]
    ): Request
     ...
     */
    public function articleDeleteImages(
        array $image_ids,
        string $contentType = self::contentTypes['articleDeleteImages'][0]
     ...
     */
    public function articleDeleteImagesWithHttpInfo(
        array $image_ids,
        string $contentType = self::contentTypes['articleDeleteImages'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelDeletedImagesModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleDeleteImagesAsync(
        array $image_ids,
        string $contentType = self::contentTypes['articleDeleteImages'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleDeleteImagesAsyncWithHttpInfo(
        $image_ids,
        string $contentType = self::contentTypes['articleDeleteImages'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleDeleteImagesRequest(
        $image_ids,
        string $contentType = self::contentTypes['articleDeleteImages'][0]
    ): Request
    {
     ...
     * @param  string|null $lookup_by Either the value id, ean or the value sku to specify the meaning of the id parameter. (optional, default to 'id')
    ...
    public function articleGetArticle(
        string $id,
        ?string $lookup_by = 'id',
        string $contentType = self::contentTypes['articleGetArticle'][0]
     ...
     */
    public function articleGetArticleWithHttpInfo(
        string $id,
        ?string $lookup_by = 'id',
        string $contentType = self::contentTypes['articleGetArticle'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleApiModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetArticleAsync(
        string $id,
        ?string $lookup_by = 'id',
        string $contentType = self::contentTypes['articleGetArticle'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function articleGetArticleAsyncWithHttpInfo(
        $id,
        $lookup_by = 'id',
        string $contentType = self::contentTypes['articleGetArticle'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetArticleRequest(
        $id,
        $lookup_by = 'id',
        string $contentType = self::contentTypes['articleGetArticle'][0]
    ): Request
    ...
    public function articleGetCategory(
        string $contentType = self::contentTypes['articleGetCategory'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleGetCategoryWithHttpInfo(
        string $contentType = self::contentTypes['articleGetCategory'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetCategoryAsync(
        string $contentType = self::contentTypes['articleGetCategory'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetCategoryAsyncWithHttpInfo(
        string $contentType = self::contentTypes['articleGetCategory'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetCategoryRequest(
        string $contentType = self::contentTypes['articleGetCategory'][0]
    ): Request
    {
    ...
    public function articleGetCustomField(
        int $id,
        string $contentType = self::contentTypes['articleGetCustomField'][0]
     ...
     */
    public function articleGetCustomFieldWithHttpInfo(
        int $id,
        string $contentType = self::contentTypes['articleGetCustomField'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleApiCustomFieldDefinitionModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetCustomFieldAsync(
        int $id,
        string $contentType = self::contentTypes['articleGetCustomField'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetCustomFieldAsyncWithHttpInfo(
        $id,
        string $contentType = self::contentTypes['articleGetCustomField'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetCustomFieldRequest(
        $id,
        string $contentType = self::contentTypes['articleGetCustomField'][0]
    ): Request
    {
    ...
    public function articleGetCustomFields(
        ?int $page = 1,
        ?int $page_size = 50,
        string $contentType = self::contentTypes['articleGetCustomFields'][0]
     ...
     */
    public function articleGetCustomFieldsWithHttpInfo(
        ?int $page = 1,
        ?int $page_size = 50,
        string $contentType = self::contentTypes['articleGetCustomFields'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelArticleApiCustomFieldDefinitionModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetCustomFieldsAsync(
        ?int $page = 1,
        ?int $page_size = 50,
        string $contentType = self::contentTypes['articleGetCustomFields'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function articleGetCustomFieldsAsyncWithHttpInfo(
        $page = 1,
        $page_size = 50,
        string $contentType = self::contentTypes['articleGetCustomFields'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetCustomFieldsRequest(
        $page = 1,
        $page_size = 50,
        string $contentType = self::contentTypes['articleGetCustomFields'][0]
    ): Request
    ...
    public function articleGetImage(
        int $image_id,
        string $contentType = self::contentTypes['articleGetImage'][0]
     ...
     */
    public function articleGetImageWithHttpInfo(
        int $image_id,
        string $contentType = self::contentTypes['articleGetImage'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetImageAsync(
        int $image_id,
        string $contentType = self::contentTypes['articleGetImage'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetImageAsyncWithHttpInfo(
        $image_id,
        string $contentType = self::contentTypes['articleGetImage'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetImageRequest(
        $image_id,
        string $contentType = self::contentTypes['articleGetImage'][0]
    ): Request
    {
    ...
    public function articleGetImageFromProduct(
        int $product_id,
        int $image_id,
        string $contentType = self::contentTypes['articleGetImageFromProduct'][0]
    ): \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel
    {
     ...
     * @return array of \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleGetImageFromProductWithHttpInfo(
        int $product_id,
        int $image_id,
        string $contentType = self::contentTypes['articleGetImageFromProduct'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function articleGetImageFromProductAsync(
        int $product_id,
        int $image_id,
        string $contentType = self::contentTypes['articleGetImageFromProduct'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function articleGetImageFromProductAsyncWithHttpInfo(
        $product_id,
        $image_id,
        string $contentType = self::contentTypes['articleGetImageFromProduct'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetImageFromProductRequest(
        $product_id,
        $image_id,
        string $contentType = self::contentTypes['articleGetImageFromProduct'][0]
    ): Request
    ...
    public function articleGetImages(
        int $product_id,
        string $contentType = self::contentTypes['articleGetImages'][0]
     ...
     */
    public function articleGetImagesWithHttpInfo(
        int $product_id,
        string $contentType = self::contentTypes['articleGetImages'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetImagesAsync(
        int $product_id,
        string $contentType = self::contentTypes['articleGetImages'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetImagesAsyncWithHttpInfo(
        $product_id,
        string $contentType = self::contentTypes['articleGetImages'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetImagesRequest(
        $product_id,
        string $contentType = self::contentTypes['articleGetImages'][0]
    ): Request
    {
     ...
     * @param  \DateTime|null $min_created_at Optional the oldest create date of the articles to be returned (optional)
     * @param  int|null $minimum_bill_bee_article_id minimum_bill_bee_article_id (optional)
     * @param  int|null $maximum_bill_bee_article_id maximum_bill_bee_article_id (optional)
    ...
    public function articleGetList(
        ?int $page = 1,
        ?int $page_size = 50,
        ?\DateTime $min_created_at = null,
        ?int $minimum_bill_bee_article_id = null,
        ?int $maximum_bill_bee_article_id = null,
        string $contentType = self::contentTypes['articleGetList'][0]
     ...
     * @param  int|null $page_size The pagesize for the result list. Values between 1 and 250 are allowed (optional, default to 50)
     * @param  \DateTime|null $min_created_at Optional the oldest create date of the articles to be returned (optional)
     * @param  int|null $minimum_bill_bee_article_id (optional)
     * @param  int|null $maximum_bill_bee_article_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['articleGetList'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function articleGetListWithHttpInfo(
        ?int $page = 1,
        ?int $page_size = 50,
        ?\DateTime $min_created_at = null,
        ?int $minimum_bill_bee_article_id = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelArticleApiModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetListAsync(
        ?int $page = 1,
        ?int $page_size = 50,
        ?\DateTime $min_created_at = null,
        ?int $minimum_bill_bee_article_id = null,
     ...
     * @return PromiseInterface
     */
    public function articleGetListAsyncWithHttpInfo(
        $page = 1,
        $page_size = 50,
        $min_created_at = null,
        $minimum_bill_bee_article_id = null,
        $maximum_bill_bee_article_id = null,
        string $contentType = self::contentTypes['articleGetList'][0]
    ): PromiseInterface
    {
        $returnType = '\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelArticleApiModel';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetListRequest(
        $page = 1,
        $page_size = 50,
        $min_created_at = null,
        $minimum_bill_bee_article_id = null,
    ...
    public function articleGetPatchableFields(
        string $contentType = self::contentTypes['articleGetPatchableFields'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleGetPatchableFieldsWithHttpInfo(
        string $contentType = self::contentTypes['articleGetPatchableFields'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetPatchableFieldsAsync(
        string $contentType = self::contentTypes['articleGetPatchableFields'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetPatchableFieldsAsyncWithHttpInfo(
        string $contentType = self::contentTypes['articleGetPatchableFields'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetPatchableFieldsRequest(
        string $contentType = self::contentTypes['articleGetPatchableFields'][0]
    ): Request
    {
     ...
     *
     * @param  string $id The id or the sku of the article to query (required)
     * @param  string|null $lookup_by Either the value id or the value sku to specify the meaning of the id parameter (optional, default to 'id')
     * @param  int|null $stock_id Optional the stock id if the multi stock feature is enabled (optional)
    ...
    public function articleGetReservedAmount(
        ...
        ?string $lookup_by = 'id',
        ?int $stock_id = null,
        string $contentType = self::contentTypes['articleGetReservedAmount'][0]
     ...
     */
    public function articleGetReservedAmountWithHttpInfo(
        string $id,
        ?string $lookup_by = 'id',
        ?int $stock_id = null,
        string $contentType = self::contentTypes['articleGetReservedAmount'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelGetReservedAmountResponseData', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetReservedAmountAsync(
        string $id,
        ?string $lookup_by = 'id',
        ?int $stock_id = null,
        string $contentType = self::contentTypes['articleGetReservedAmount'][0]
     ...
     * @return PromiseInterface
     */
    public function articleGetReservedAmountAsyncWithHttpInfo(
        $id,
        $lookup_by = 'id',
        $stock_id = null,
        string $contentType = self::contentTypes['articleGetReservedAmount'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetReservedAmountRequest(
        $id,
        $lookup_by = 'id',
        $stock_id = null,
        string $contentType = self::contentTypes['articleGetReservedAmount'][0]
    ...
    public function articleGetStocks(
        string $contentType = self::contentTypes['articleGetStocks'][0]
     ...
     */
    public function articleGetStocksWithHttpInfo(
        string $contentType = self::contentTypes['articleGetStocks'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelStockResponseData', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleGetStocksAsync(
        string $contentType = self::contentTypes['articleGetStocks'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleGetStocksAsyncWithHttpInfo(
        string $contentType = self::contentTypes['articleGetStocks'][0]
    ): PromiseInterface
    {
        $returnType = '\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelStockResponseData';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleGetStocksRequest(
        string $contentType = self::contentTypes['articleGetStocks'][0]
    ): Request
    {
    ...
    public function articlePatchArticle(
        int $id,
        array $model,
        string $contentType = self::contentTypes['articlePatchArticle'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function articlePatchArticleWithHttpInfo(
        int $id,
        array $model,
        string $contentType = self::contentTypes['articlePatchArticle'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function articlePatchArticleAsync(
        int $id,
        array $model,
        string $contentType = self::contentTypes['articlePatchArticle'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function articlePatchArticleAsyncWithHttpInfo(
        $id,
        $model,
        string $contentType = self::contentTypes['articlePatchArticle'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articlePatchArticleRequest(
        $id,
        $model,
        string $contentType = self::contentTypes['articlePatchArticle'][0]
    ): Request
     ...
     * @return \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel
     */
    public function articlePutImage(
        int $product_id,
        int $image_id,
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel $model,
        string $contentType = self::contentTypes['articlePutImage'][0]
    ): \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel
    {
     ...
     * @return array of \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function articlePutImageWithHttpInfo(
        int $product_id,
        int $image_id,
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel $model,
        string $contentType = self::contentTypes['articlePutImage'][0]
     ...
     * @return PromiseInterface
     */
    public function articlePutImageAsync(
        int $product_id,
        int $image_id,
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel $model,
        string $contentType = self::contentTypes['articlePutImage'][0]
     ...
     * @return PromiseInterface
     */
    public function articlePutImageAsyncWithHttpInfo(
        $product_id,
        $image_id,
        $model,
        string $contentType = self::contentTypes['articlePutImage'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articlePutImageRequest(
        $product_id,
        $image_id,
        $model,
        string $contentType = self::contentTypes['articlePutImage'][0]
     ...
     * @param  bool|null $replace If you pass true, the images will be replaced by the passed images. Otherwise the passed images will be appended to the product. (optional, default to false)
     ...
     * @return \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel
     */
    public function articlePutImages(
        int $product_id,
        array $models,
        ?bool $replace = false,
        string $contentType = self::contentTypes['articlePutImages'][0]
    ): \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel
    {
     ...
     * @return array of \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelArticleImageRelationApiModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function articlePutImagesWithHttpInfo(
        int $product_id,
        array $models,
        ?bool $replace = false,
        string $contentType = self::contentTypes['articlePutImages'][0]
     ...
     * @return PromiseInterface
     */
    public function articlePutImagesAsync(
        int $product_id,
        array $models,
        ?bool $replace = false,
        string $contentType = self::contentTypes['articlePutImages'][0]
     ...
     * @return PromiseInterface
     */
    public function articlePutImagesAsyncWithHttpInfo(
        $product_id,
        $models,
        $replace = false,
        string $contentType = self::contentTypes['articlePutImages'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articlePutImagesRequest(
        $product_id,
        $models,
        $replace = false,
        string $contentType = self::contentTypes['articlePutImages'][0]
     ...
     */
    public function articleUpdateStock(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelUpdateStockApiModel $model,
        string $contentType = self::contentTypes['articleUpdateStock'][0]
     ...
     */
    public function articleUpdateStockWithHttpInfo(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelUpdateStockApiModel $model,
        string $contentType = self::contentTypes['articleUpdateStock'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelUpdateStockResponseData', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleUpdateStockAsync(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelUpdateStockApiModel $model,
        string $contentType = self::contentTypes['articleUpdateStock'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleUpdateStockAsyncWithHttpInfo(
        $model,
        string $contentType = self::contentTypes['articleUpdateStock'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleUpdateStockRequest(
        $model,
        string $contentType = self::contentTypes['articleUpdateStock'][0]
    ): Request
    {
     ...
     */
    public function articleUpdateStockCode(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelUpdateStockCodeApiModel $model,
        string $contentType = self::contentTypes['articleUpdateStockCode'][0]
     ...
     */
    public function articleUpdateStockCodeWithHttpInfo(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelUpdateStockCodeApiModel $model,
        string $contentType = self::contentTypes['articleUpdateStockCode'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelUpdateStockCodeResponseData', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function articleUpdateStockCodeAsync(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelUpdateStockCodeApiModel $model,
        string $contentType = self::contentTypes['articleUpdateStockCode'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleUpdateStockCodeAsyncWithHttpInfo(
        $model,
        string $contentType = self::contentTypes['articleUpdateStockCode'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleUpdateStockCodeRequest(
        $model,
        string $contentType = self::contentTypes['articleUpdateStockCode'][0]
    ): Request
    {
     ...
     * @return \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelUpdateStockResponseData[]
     */
    public function articleUpdateStockMultiple(
        array $models,
        string $contentType = self::contentTypes['articleUpdateStockMultiple'][0]
    ): array
    {
     ...
     * @return array of \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelUpdateStockResponseData[], HTTP status code, HTTP response headers (array of strings)
     */
    public function articleUpdateStockMultipleWithHttpInfo(
        array $models,
        string $contentType = self::contentTypes['articleUpdateStockMultiple'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function articleUpdateStockMultipleAsync(
        array $models,
        string $contentType = self::contentTypes['articleUpdateStockMultiple'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function articleUpdateStockMultipleAsyncWithHttpInfo(
        $models,
        string $contentType = self::contentTypes['articleUpdateStockMultiple'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleUpdateStockMultipleRequest(
        $models,
        string $contentType = self::contentTypes['articleUpdateStockMultiple'][0]
    ): Request
    {
