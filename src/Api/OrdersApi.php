...
class OrdersApi
{
    ...
    public function layoutApiGetList(
        string $contentType = self::contentTypes['layoutApiGetList'][0]
     ...
     */
    public function layoutApiGetListWithHttpInfo(
        string $contentType = self::contentTypes['layoutApiGetList'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelsLayoutTemplate', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function layoutApiGetListAsync(
        string $contentType = self::contentTypes['layoutApiGetList'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function layoutApiGetListAsyncWithHttpInfo(
        string $contentType = self::contentTypes['layoutApiGetList'][0]
    ): PromiseInterface
    {
        $returnType = '\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelsLayoutTemplate';
     ...
     */
    public function layoutApiGetListRequest(
        string $contentType = self::contentTypes['layoutApiGetList'][0]
    ): Request
    {
     ...
     * @return void
     */
    public function orderApiAddShipment(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiAddShipmentToOrderModel $model,
        string $contentType = self::contentTypes['orderApiAddShipment'][0]
    ): void
    {
     ...
     */
    public function orderApiAddShipmentWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiAddShipmentToOrderModel $model,
        string $contentType = self::contentTypes['orderApiAddShipment'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiAddShipmentAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiAddShipmentToOrderModel $model,
        string $contentType = self::contentTypes['orderApiAddShipment'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiAddShipmentAsyncWithHttpInfo(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiAddShipment'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiAddShipmentRequest(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiAddShipment'][0]
    ): Request
     ...
     *
     * @param  int $id The internal billbee id of the order (required)
     * @param  bool|null $include_pdf If true, the PDF is included in the response as base64 encoded string (optional, default to false)
     * @param  int|null $send_to_cloud_id Optionally specify the id of a billbee connected cloud device to send the pdf to (optional)
    ...
    public function orderApiCreateDeliveryNote(
        int $id,
        ?bool $include_pdf = false,
        ?int $send_to_cloud_id = null,
        string $contentType = self::contentTypes['orderApiCreateDeliveryNote'][0]
    ): object
    {
     ...
     */
    public function orderApiCreateDeliveryNoteWithHttpInfo(
        int $id,
        ?bool $include_pdf = false,
        ?int $send_to_cloud_id = null,
        string $contentType = self::contentTypes['orderApiCreateDeliveryNote'][0]
     ...
     * @return PromiseInterface
     */
    public function orderApiCreateDeliveryNoteAsync(
        int $id,
        ?bool $include_pdf = false,
        ?int $send_to_cloud_id = null,
        string $contentType = self::contentTypes['orderApiCreateDeliveryNote'][0]
     ...
     * @return PromiseInterface
     */
    public function orderApiCreateDeliveryNoteAsyncWithHttpInfo(
        $id,
        $include_pdf = false,
        $send_to_cloud_id = null,
        string $contentType = self::contentTypes['orderApiCreateDeliveryNote'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiCreateDeliveryNoteRequest(
        $id,
        $include_pdf = false,
        $send_to_cloud_id = null,
        string $contentType = self::contentTypes['orderApiCreateDeliveryNote'][0]
     ...
     *
     * @param  int $id The internal billbee id of the order (required)
     * @param  bool|null $include_invoice_pdf If true, the PDF is included in the response as base64 encoded string (optional, default to false)
     * @param  int|null $template_id You can pass the id of an invoice template to overwrite the assigned template for invoice creation (optional)
     * @param  int|null $send_to_cloud_id You can pass the id of a connected cloud printer/storage to send the invoice to it (optional)
    ...
    public function orderApiCreateInvoice(
        int $id,
        ?bool $include_invoice_pdf = false,
        ?int $template_id = null,
        ?int $send_to_cloud_id = null,
        string $contentType = self::contentTypes['orderApiCreateInvoice'][0]
     ...
     */
    public function orderApiCreateInvoiceWithHttpInfo(
        int $id,
        ?bool $include_invoice_pdf = false,
        ?int $template_id = null,
        ?int $send_to_cloud_id = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfRechnungsdruckWebAppControllersApiInvoice', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function orderApiCreateInvoiceAsync(
        int $id,
        ?bool $include_invoice_pdf = false,
        ?int $template_id = null,
        ?int $send_to_cloud_id = null,
     ...
     * @return PromiseInterface
     */
    public function orderApiCreateInvoiceAsyncWithHttpInfo(
        $id,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiCreateInvoiceRequest(
        $id,
        $include_invoice_pdf = false,
        $template_id = null,
        $send_to_cloud_id = null,
    ...
    public function orderApiFind(
        string $id,
        string $partner,
        string $contentType = self::contentTypes['orderApiFind'][0]
    ): object
    {
     ...
     * @deprecated
     */
    public function orderApiFindWithHttpInfo(
        string $id,
        string $partner,
        string $contentType = self::contentTypes['orderApiFind'][0]
    ): array
     ...
     * @deprecated
     */
    public function orderApiFindAsync(
        string $id,
        string $partner,
        string $contentType = self::contentTypes['orderApiFind'][0]
    ): PromiseInterface
     ...
     * @deprecated
     */
    public function orderApiFindAsyncWithHttpInfo(
        $id,
        $partner,
        string $contentType = self::contentTypes['orderApiFind'][0]
    ): PromiseInterface
     ...
     * @deprecated
     */
    public function orderApiFindRequest(
        $id,
        $partner,
        string $contentType = self::contentTypes['orderApiFind'][0]
    ): Request
     ...
     *
     * @param  int $id The internal billbee id of the order (required)
     * @param  int|null $article_title_source The source field for the article title. 0 &#x3D; Order Position (default), 1 &#x3D; Article Title, 2 &#x3D; Article Invoice Text (optional, default to 0)
    ...
    public function orderApiGet(
        int $id,
        ?int $article_title_source = 0,
        string $contentType = self::contentTypes['orderApiGet'][0]
    ): \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder
    {
     ...
     */
    public function orderApiGetWithHttpInfo(
        int $id,
        ?int $article_title_source = 0,
        string $contentType = self::contentTypes['orderApiGet'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function orderApiGetAsync(
        int $id,
        ?int $article_title_source = 0,
        string $contentType = self::contentTypes['orderApiGet'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiGetAsyncWithHttpInfo(
        $id,
        $article_title_source = 0,
        string $contentType = self::contentTypes['orderApiGet'][0]
    ): PromiseInterface
    {
        $returnType = '\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiGetRequest(
        $id,
        $article_title_source = 0,
        string $contentType = self::contentTypes['orderApiGet'][0]
    ): Request
    ...
    public function orderApiGetByExtRef(
        string $ext_ref,
        string $contentType = self::contentTypes['orderApiGetByExtRef'][0]
    ): \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder
    {
     ...
     * @return array of \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiGetByExtRefWithHttpInfo(
        string $ext_ref,
        string $contentType = self::contentTypes['orderApiGetByExtRef'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function orderApiGetByExtRefAsync(
        string $ext_ref,
        string $contentType = self::contentTypes['orderApiGetByExtRef'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function orderApiGetByExtRefAsyncWithHttpInfo(
        $ext_ref,
        string $contentType = self::contentTypes['orderApiGetByExtRef'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiGetByExtRefRequest(
        $ext_ref,
        string $contentType = self::contentTypes['orderApiGetByExtRef'][0]
    ): Request
    {
     ...
     *
     * @param  \DateTime|null $min_invoice_date Specifies the oldest invoice date to include (optional)
     * @param  \DateTime|null $max_invoice_date Specifies the newest invoice date to include (optional)
     * @param  int|null $page Specifies the page to request (optional, default to 1)
     * @param  int|null $page_size Specifies the pagesize. Defaults to 50, max value is 250 (optional, default to 50)
     * @param  int[]|null $shop_id Specifies a list of shop ids for which invoices should be included (optional)
     * @param  int[]|null $order_state_id Specifies a list of state ids to include in the response (optional)
     * @param  string[]|null $tag tag (optional)
     * @param  \DateTime|null $min_pay_date min_pay_date (optional)
     * @param  \DateTime|null $max_pay_date max_pay_date (optional)
     * @param  bool|null $include_positions include_positions (optional, default to false)
     * @param  bool|null $exclude_tags If true the list of tags passed to the call are used to filter orders to not include these tags (optional, default to false)
    ...
    public function orderApiGetInvoiceList(
        ?\DateTime $min_invoice_date = null,
        ?\DateTime $max_invoice_date = null,
        ?int $page = 1,
        ?int $page_size = 50,
        ?array $shop_id = null,
        ?array $order_state_id = null,
        ?array $tag = null,
        ?\DateTime $min_pay_date = null,
        ?\DateTime $max_pay_date = null,
        ?bool $include_positions = false,
        ?bool $exclude_tags = false,
        string $contentType = self::contentTypes['orderApiGetInvoiceList'][0]
     ...
     * @param  \DateTime|null $min_pay_date (optional)
     * @param  \DateTime|null $max_pay_date (optional)
     * @param  bool|null $include_positions (optional, default to false)
     * @param  bool|null $exclude_tags If true the list of tags passed to the call are used to filter orders to not include these tags (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['orderApiGetInvoiceList'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     ...
     */
    public function orderApiGetInvoiceListWithHttpInfo(
        ?\DateTime $min_invoice_date = null,
        ?\DateTime $max_invoice_date = null,
        ?int $page = 1,
        ?int $page_size = 50,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelInvoiceApiModel', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function orderApiGetInvoiceListAsync(
        ?\DateTime $min_invoice_date = null,
        ?\DateTime $max_invoice_date = null,
        ?int $page = 1,
        ?int $page_size = 50,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiGetInvoiceListRequest(
        $min_invoice_date = null,
        $max_invoice_date = null,
        $page = 1,
        $page_size = 50,
     ...
     *
     * @param  \DateTime|null $min_order_date Specifies the oldest order date to include in the response (optional)
     * @param  \DateTime|null $max_order_date Specifies the newest order date to include in the response (optional)
     * @param  int|null $page Specifies the page to request (optional, default to 1)
     * @param  int|null $page_size Specifies the pagesize. Defaults to 50, max value is 250 (optional, default to 50)
     * @param  int[]|null $shop_id Specifies a list of shop ids for which invoices should be included (optional)
     * @param  int[]|null $order_state_id Specifies a list of state ids to include in the response (optional)
     * @param  string[]|null $tag Specifies a list of tags the order must have attached to be included in the response (optional)
     * @param  int|null $minimum_bill_bee_order_id If given, all delivered orders have an Id greater than or equal to the given minimumOrderId (optional)
     * @param  \DateTime|null $modified_at_min If given, the last modification has to be newer than the given date (optional)
     * @param  \DateTime|null $modified_at_max If given, the last modification has to be older or equal than the given date. (optional)
     * @param  int|null $article_title_source The source field for the article title. 0 &#x3D; Order Position (default), 1 &#x3D; Article Title, 2 &#x3D; Article Invoice Text (optional, default to 0)
     * @param  bool|null $exclude_tags If true the list of tags passed to the call are used to filter orders to not include these tags (optional, default to false)
    ...
    public function orderApiGetList(
        ?\DateTime $min_order_date = null,
        ?\DateTime $max_order_date = null,
        ?int $page = 1,
        ?int $page_size = 50,
        ?array $shop_id = null,
        ?array $order_state_id = null,
        ?array $tag = null,
        ?int $minimum_bill_bee_order_id = null,
        ?\DateTime $modified_at_min = null,
        ?\DateTime $modified_at_max = null,
        ?int $article_title_source = 0,
        ?bool $exclude_tags = false,
        string $contentType = self::contentTypes['orderApiGetList'][0]
     ...
     */
    public function orderApiGetListWithHttpInfo(
        ?\DateTime $min_order_date = null,
        ?\DateTime $max_order_date = null,
        ?int $page = 1,
        ?int $page_size = 50,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelOrder', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function orderApiGetListAsync(
        ?\DateTime $min_order_date = null,
        ?\DateTime $max_order_date = null,
        ?int $page = 1,
        ?int $page_size = 50,
    ...
    public function orderApiGetListAsyncWithHttpInfo(
        ...
        $order_state_id = null,
        $tag = null,
        $minimum_bill_bee_order_id = null,
        $modified_at_min = null,
        $modified_at_max = null,
        $article_title_source = 0,
        $exclude_tags = false,
        string $contentType = self::contentTypes['orderApiGetList'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiGetListRequest(
        $min_order_date = null,
        $max_order_date = null,
        $page = 1,
        $page_size = 50,
    ...
    public function orderApiGetPatchableFields(
        string $contentType = self::contentTypes['orderApiGetPatchableFields'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiGetPatchableFieldsWithHttpInfo(
        string $contentType = self::contentTypes['orderApiGetPatchableFields'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function orderApiGetPatchableFieldsAsync(
        string $contentType = self::contentTypes['orderApiGetPatchableFields'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function orderApiGetPatchableFieldsAsyncWithHttpInfo(
        string $contentType = self::contentTypes['orderApiGetPatchableFields'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiGetPatchableFieldsRequest(
        string $contentType = self::contentTypes['orderApiGetPatchableFields'][0]
    ): Request
    {
     ...
     * @return object
     */
    public function orderApiMessage(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppModelApiOrderMessageModel $order_message,
        string $contentType = self::contentTypes['orderApiMessage'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiMessageWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppModelApiOrderMessageModel $order_message,
        string $contentType = self::contentTypes['orderApiMessage'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiMessageAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppModelApiOrderMessageModel $order_message,
        string $contentType = self::contentTypes['orderApiMessage'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiMessageAsyncWithHttpInfo(
        $id,
        $order_message,
        string $contentType = self::contentTypes['orderApiMessage'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiMessageRequest(
        $id,
        $order_message,
        string $contentType = self::contentTypes['orderApiMessage'][0]
    ): Request
     ...
     * @return object
     */
    public function orderApiParsePlaceholders(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerParseTextContainer $container,
        string $contentType = self::contentTypes['orderApiParsePlaceholders'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiParsePlaceholdersWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerParseTextContainer $container,
        string $contentType = self::contentTypes['orderApiParsePlaceholders'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiParsePlaceholdersAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerParseTextContainer $container,
        string $contentType = self::contentTypes['orderApiParsePlaceholders'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiParsePlaceholdersAsyncWithHttpInfo(
        $id,
        $container,
        string $contentType = self::contentTypes['orderApiParsePlaceholders'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiParsePlaceholdersRequest(
        $id,
        $container,
        string $contentType = self::contentTypes['orderApiParsePlaceholders'][0]
    ): Request
    ...
    public function orderApiPatchOrder(
        int $id,
        array $model,
        string $contentType = self::contentTypes['orderApiPatchOrder'][0]
    ): \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder
    {
     ...
     * @return array of \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiPatchOrderWithHttpInfo(
        int $id,
        array $model,
        string $contentType = self::contentTypes['orderApiPatchOrder'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiPatchOrderAsync(
        int $id,
        array $model,
        string $contentType = self::contentTypes['orderApiPatchOrder'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiPatchOrderAsyncWithHttpInfo(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiPatchOrder'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiPatchOrderRequest(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiPatchOrder'][0]
    ): Request
     ...
     * @param  int|null $shop_id Deprecated, if orderData.ApiAccountId is set, it will be used instead of &#39;shopId&#39; (optional)
     ...
     * @return \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder
     */
    public function orderApiPostNewOrder(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrder $order_data,
        ?int $shop_id = null,
        string $contentType = self::contentTypes['orderApiPostNewOrder'][0]
    ): \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder
    {
     ...
     * @return array of \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiPostNewOrderWithHttpInfo(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrder $order_data,
        ?int $shop_id = null,
        string $contentType = self::contentTypes['orderApiPostNewOrder'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiPostNewOrderAsync(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrder $order_data,
        ?int $shop_id = null,
        string $contentType = self::contentTypes['orderApiPostNewOrder'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiPostNewOrderAsyncWithHttpInfo(
        $order_data,
        $shop_id = null,
        string $contentType = self::contentTypes['orderApiPostNewOrder'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiPostNewOrderRequest(
        $order_data,
        $shop_id = null,
        string $contentType = self::contentTypes['orderApiPostNewOrder'][0]
    ): Request
     ...
     * @return object
     */
    public function orderApiSendMessage(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerSendMessageModel $model,
        string $contentType = self::contentTypes['orderApiSendMessage'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiSendMessageWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerSendMessageModel $model,
        string $contentType = self::contentTypes['orderApiSendMessage'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiSendMessageAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerSendMessageModel $model,
        string $contentType = self::contentTypes['orderApiSendMessage'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiSendMessageAsyncWithHttpInfo(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiSendMessage'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiSendMessageRequest(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiSendMessage'][0]
    ): Request
     ...
     * @return object
     */
    public function orderApiTagsCreate(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderTagCreate $tag_data,
        string $contentType = self::contentTypes['orderApiTagsCreate'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiTagsCreateWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderTagCreate $tag_data,
        string $contentType = self::contentTypes['orderApiTagsCreate'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiTagsCreateAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderTagCreate $tag_data,
        string $contentType = self::contentTypes['orderApiTagsCreate'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiTagsCreateAsyncWithHttpInfo(
        $id,
        $tag_data,
        string $contentType = self::contentTypes['orderApiTagsCreate'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiTagsCreateRequest(
        $id,
        $tag_data,
        string $contentType = self::contentTypes['orderApiTagsCreate'][0]
    ): Request
     ...
     * @return object
     */
    public function orderApiTagsUpdate(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderTagCreate $tag_data,
        string $contentType = self::contentTypes['orderApiTagsUpdate'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiTagsUpdateWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderTagCreate $tag_data,
        string $contentType = self::contentTypes['orderApiTagsUpdate'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiTagsUpdateAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderTagCreate $tag_data,
        string $contentType = self::contentTypes['orderApiTagsUpdate'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiTagsUpdateAsyncWithHttpInfo(
        $id,
        $tag_data,
        string $contentType = self::contentTypes['orderApiTagsUpdate'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiTagsUpdateRequest(
        $id,
        $tag_data,
        string $contentType = self::contentTypes['orderApiTagsUpdate'][0]
    ): Request
     ...
     * @return object
     */
    public function orderApiTriggerEvent(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerTriggerEventContainer $model,
        string $contentType = self::contentTypes['orderApiTriggerEvent'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiTriggerEventWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerTriggerEventContainer $model,
        string $contentType = self::contentTypes['orderApiTriggerEvent'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiTriggerEventAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderApiControllerTriggerEventContainer $model,
        string $contentType = self::contentTypes['orderApiTriggerEvent'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiTriggerEventAsyncWithHttpInfo(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiTriggerEvent'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiTriggerEventRequest(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiTriggerEvent'][0]
    ): Request
     ...
     * @return void
     */
    public function orderApiUpdateState(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderStateUpdate $model,
        string $contentType = self::contentTypes['orderApiUpdateState'][0]
    ): void
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderApiUpdateStateWithHttpInfo(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderStateUpdate $model,
        string $contentType = self::contentTypes['orderApiUpdateState'][0]
    ): array
     ...
     * @return PromiseInterface
     */
    public function orderApiUpdateStateAsync(
        int $id,
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiOrderStateUpdate $model,
        string $contentType = self::contentTypes['orderApiUpdateState'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function orderApiUpdateStateAsyncWithHttpInfo(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiUpdateState'][0]
    ): PromiseInterface
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function orderApiUpdateStateRequest(
        $id,
        $model,
        string $contentType = self::contentTypes['orderApiUpdateState'][0]
    ): Request
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchSearch_1'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
    ...
    {
        list($response) = $this->searchSearch_1WithHttpInfo($model, $contentType);
        return $response;
    }

    /**
     * Operation searchSearch_1WithHttpInfo
     *
     * Search for products, customers and orders.  Type can be \&quot;order\&quot;, \&quot;product\&quot; and / or \&quot;customer\&quot;  Term can contain lucene query syntax
     *
     ...
     */
    public function searchSearch_1WithHttpInfo(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiSearchControllerSearchModel $model,
        string $contentType = self::contentTypes['searchSearch_1'][0]
    ): array
    {
        $request = $this->searchSearch_1Request($model, $contentType);
     ...
     * @return PromiseInterface
     */
    public function searchSearch_1Async(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiSearchControllerSearchModel $model,
        string $contentType = self::contentTypes['searchSearch_1'][0]
    ): PromiseInterface
    {
        return $this->searchSearch_1AsyncWithHttpInfo($model, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation searchSearch_1AsyncWithHttpInfo
     *
     * Search for products, customers and orders.  Type can be \&quot;order\&quot;, \&quot;product\&quot; and / or \&quot;customer\&quot;  Term can contain lucene query syntax
     *
     * @param  \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiSearchControllerSearchModel $model (required)
     ...
     * @return PromiseInterface
     */
    public function searchSearch_1AsyncWithHttpInfo(
        $model,
        string $contentType = self::contentTypes['searchSearch_1'][0]
    ): PromiseInterface
    {
    ...
    /**
     * Create request for operation 'searchSearch_1'
     *
     * @param  \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiSearchControllerSearchModel $model (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchSearch_1'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchSearch_1Request(
        $model,
        string $contentType = self::contentTypes['searchSearch_1'][0]
    ): Request
    {
        ...
        if ($model === null || (is_array($model) && count($model) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $model when calling searchSearch_1'
            );
        }
