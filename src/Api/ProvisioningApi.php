...
class ProvisioningApi
{
     ...
     * @return object
     */
    public function automaticProvisioningCreateAccount(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainer $model,
        string $contentType = self::contentTypes['automaticProvisioningCreateAccount'][0]
    ): object
    {
     ...
     */
    public function automaticProvisioningCreateAccountWithHttpInfo(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainer $model,
        string $contentType = self::contentTypes['automaticProvisioningCreateAccount'][0]
    ): array
    {
     ...
     */
    public function automaticProvisioningCreateAccountAsync(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainer $model,
        string $contentType = self::contentTypes['automaticProvisioningCreateAccount'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function automaticProvisioningCreateAccountAsyncWithHttpInfo(
        $model,
        string $contentType = self::contentTypes['automaticProvisioningCreateAccount'][0]
    ): PromiseInterface
    {
     ...
     */
    public function automaticProvisioningCreateAccountRequest(
        $model,
        string $contentType = self::contentTypes['automaticProvisioningCreateAccount'][0]
    ): Request
    {
    ...
    public function automaticProvisioningTermsInfo(
        string $contentType = self::contentTypes['automaticProvisioningTermsInfo'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function automaticProvisioningTermsInfoWithHttpInfo(
        string $contentType = self::contentTypes['automaticProvisioningTermsInfo'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function automaticProvisioningTermsInfoAsync(
        string $contentType = self::contentTypes['automaticProvisioningTermsInfo'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function automaticProvisioningTermsInfoAsyncWithHttpInfo(
        string $contentType = self::contentTypes['automaticProvisioningTermsInfo'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function automaticProvisioningTermsInfoRequest(
        string $contentType = self::contentTypes['automaticProvisioningTermsInfo'][0]
    ): Request
    {
