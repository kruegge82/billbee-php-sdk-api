...
class ShipmentsApi
{
     ...
     * @param  \DateTime|null $created_at_min Specifies the oldest shipment date to include in the response (optional)
     * @param  \DateTime|null $created_at_max Specifies the newest shipment date to include in the response (optional)
     * @param  int|null $order_id Get shipments for this order only. (optional)
     * @param  int|null $minimum_shipment_id Get Shipments with a shipment greater or equal than this id. New shipments have a greater id than older shipments. (optional)
     * @param  int|null $shipping_provider_id Get Shippings for the specified shipping provider only. &lt;seealso cref&#x3D;\&quot;M:Rechnungsdruck.WebApp.Controllers.Api.ShipmentController.GetShippingproviders\&quot; /&gt; (optional)
    ...
    public function shipmentGetList(
        ?int $page = 1,
        ?int $page_size = 50,
        ?\DateTime $created_at_min = null,
        ?\DateTime $created_at_max = null,
        ?int $order_id = null,
        ?int $minimum_shipment_id = null,
        ?int $shipping_provider_id = null,
        string $contentType = self::contentTypes['shipmentGetList'][0]
     ...
     */
    public function shipmentGetListWithHttpInfo(
        ?int $page = 1,
        ?int $page_size = 50,
        ?\DateTime $created_at_min = null,
        ?\DateTime $created_at_max = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIModelShipment', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
     ...
     */
    public function shipmentGetListAsync(
        ?int $page = 1,
        ?int $page_size = 50,
        ?\DateTime $created_at_min = null,
        ?\DateTime $created_at_max = null,
     ...
     * @return PromiseInterface
     */
    public function shipmentGetListAsyncWithHttpInfo(
        $page = 1,
        $page_size = 50,
        $created_at_min = null,
        $created_at_max = null,
        $order_id = null,
        $minimum_shipment_id = null,
     ...
     */
    public function shipmentGetListRequest(
        $page = 1,
        $page_size = 50,
        $created_at_min = null,
        $created_at_max = null,
    ...
    public function shipmentGetPing(
        string $contentType = self::contentTypes['shipmentGetPing'][0]
    ): object
    {
     ...
     * @deprecated
     */
    public function shipmentGetPingWithHttpInfo(
        string $contentType = self::contentTypes['shipmentGetPing'][0]
    ): array
    {
     ...
     * @deprecated
     */
    public function shipmentGetPingAsync(
        string $contentType = self::contentTypes['shipmentGetPing'][0]
    ): PromiseInterface
    {
     ...
     * @deprecated
     */
    public function shipmentGetPingAsyncWithHttpInfo(
        string $contentType = self::contentTypes['shipmentGetPing'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @deprecated
     */
    public function shipmentGetPingRequest(
        string $contentType = self::contentTypes['shipmentGetPing'][0]
    ): Request
    {
    ...
    public function shipmentGetShippingCarrier(
        string $contentType = self::contentTypes['shipmentGetShippingCarrier'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function shipmentGetShippingCarrierWithHttpInfo(
        string $contentType = self::contentTypes['shipmentGetShippingCarrier'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function shipmentGetShippingCarrierAsync(
        string $contentType = self::contentTypes['shipmentGetShippingCarrier'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function shipmentGetShippingCarrierAsyncWithHttpInfo(
        string $contentType = self::contentTypes['shipmentGetShippingCarrier'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentGetShippingCarrierRequest(
        string $contentType = self::contentTypes['shipmentGetShippingCarrier'][0]
    ): Request
    {
    ...
    public function shipmentGetShippingproviders(
        string $contentType = self::contentTypes['shipmentGetShippingproviders'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function shipmentGetShippingprovidersWithHttpInfo(
        string $contentType = self::contentTypes['shipmentGetShippingproviders'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function shipmentGetShippingprovidersAsync(
        string $contentType = self::contentTypes['shipmentGetShippingproviders'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function shipmentGetShippingprovidersAsyncWithHttpInfo(
        string $contentType = self::contentTypes['shipmentGetShippingproviders'][0]
    ): PromiseInterface
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentGetShippingprovidersRequest(
        string $contentType = self::contentTypes['shipmentGetShippingproviders'][0]
    ): Request
    {
     ...
     * @return object
     */
    public function shipmentPostShipment(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelCreateShipmentApiModel $model,
        string $contentType = self::contentTypes['shipmentPostShipment'][0]
    ): object
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function shipmentPostShipmentWithHttpInfo(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelCreateShipmentApiModel $model,
        string $contentType = self::contentTypes['shipmentPostShipment'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function shipmentPostShipmentAsync(
        \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelCreateShipmentApiModel $model,
        string $contentType = self::contentTypes['shipmentPostShipment'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function shipmentPostShipmentAsyncWithHttpInfo(
        $model,
        string $contentType = self::contentTypes['shipmentPostShipment'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentPostShipmentRequest(
        $model,
        string $contentType = self::contentTypes['shipmentPostShipment'][0]
    ): Request
    {
     ...
     */
    public function shipmentShipWithLabel(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiShipmentWithLabel $shipment_information,
        string $contentType = self::contentTypes['shipmentShipWithLabel'][0]
     ...
     */
    public function shipmentShipWithLabelWithHttpInfo(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiShipmentWithLabel $shipment_information,
        string $contentType = self::contentTypes['shipmentShipWithLabel'][0]
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiResultOfRechnungsdruckWebAppControllersApiShipmentWithLabelResult', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function shipmentShipWithLabelAsync(
        \kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiShipmentWithLabel $shipment_information,
        string $contentType = self::contentTypes['shipmentShipWithLabel'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function shipmentShipWithLabelAsyncWithHttpInfo(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentShipWithLabelRequest(
        $shipment_information,
        string $contentType = self::contentTypes['shipmentShipWithLabel'][0]
    ): Request
    {
