...
class RechnungsdruckWebAppControllersApiApiResultOfRechnungsdruckWebAppControllersApiInvoice implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Rechnungsdruck.WebApp.Controllers.Api.ApiResultOfRechnungsdruck.WebApp.Controllers.Api.Invoice';
    ...
    */
     ...
     */
    public function getData(): ?\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiInvoice
    {
     ...
     * @return $this
     */
    public function setData(?\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiInvoice $data): static
    {
        if (is_null($data)) {
