...
class RechnungsdruckWebAppControllersApiApiPagedResultOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIShopAccountReadApiModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Rechnungsdruck.WebApp.Controllers.Api.ApiPagedResultOfSystem.Collections.Generic.ListOfBillbee.Interfaces.BillbeeAPI.ShopAccountReadApiModel';
    ...
    */
     ...
     */
    public function getPaging(): ?\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultPagingInformationOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIShopAccountReadApiModel
    {
     ...
     * @return $this
     */
    public function setPaging(?\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiApiPagedResultPagingInformationOfSystemCollectionsGenericListOfBillbeeInterfacesBillbeeAPIShopAccountReadApiModel $paging): static
    {
        if (is_null($paging)) {
