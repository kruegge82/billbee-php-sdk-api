...
/**
 * RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder Class Doc Comment
 *
 * @package  kruegge82\billbee
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RechnungsdruckWebAppControllersApiApiResultOfBillbeeInterfacesBillbeeAPIModelOrder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Rechnungsdruck.WebApp.Controllers.Api.ApiResultOfBillbee.Interfaces.BillbeeAPI.Model.Order';
    ...
    */
     ...
     */
    public function getData(): ?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrder
    {
     ...
     * @return $this
     */
    public function setData(?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrder $data): static
    {
        if (is_null($data)) {
