...
class BillbeeInterfacesBillbeeAPIModelCustomerAddressApiModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Billbee.Interfaces.BillbeeAPI.Model.CustomerAddressApiModel';
    ...
    public const ADDRESS_TYPE_NUMBER_1 = 1;
    public const ADDRESS_TYPE_NUMBER_2 = 2;
    ...
    {
        return [
            self::ADDRESS_TYPE_NUMBER_1,
            self::ADDRESS_TYPE_NUMBER_2,
        ];
    }
    ...
    */
     ...
     * @return $this
     */
    public function setAddressType(?int $address_type): static
    {
