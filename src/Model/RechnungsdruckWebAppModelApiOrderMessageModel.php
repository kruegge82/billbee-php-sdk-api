...
/**
 * RechnungsdruckWebAppModelApiOrderMessageModel Class Doc Comment
 *
 * @package  kruegge82\billbee
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RechnungsdruckWebAppModelApiOrderMessageModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Rechnungsdruck.WebApp.Model.Api.OrderMessageModel';
    ...
    */
     ...
     * Sets is_internal
     *
     * @param bool|null $is_internal Whether the message is only for internal usage or not.
     *
     * @return $this
     */
     ...
     * Sets sender_name
     *
     * @param string|null $sender_name The name of the entity (e.g. Name of the API Partner) creating this message.
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string|null $text The text describing what happened.
     *
     * @return $this
     */
