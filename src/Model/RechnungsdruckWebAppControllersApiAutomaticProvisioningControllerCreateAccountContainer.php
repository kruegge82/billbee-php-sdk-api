...
class RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Rechnungsdruck.WebApp.Controllers.Api.AutomaticProvisioningController.CreateAccountContainer';
    ...
    */
     ...
     * @return $this
     */
    public function setAcceptTerms(?bool $accept_terms): static
    {
     ...
     */
    public function getAddress(): ?\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainerUserAddress
    {
     ...
     * @return $this
     */
    public function setAddress(?\kruegge82\billbee\Model\RechnungsdruckWebAppControllersApiAutomaticProvisioningControllerCreateAccountContainerUserAddress $address): static
    {
        if (is_null($address)) {
     ...
     * @return string|null
     */
    public function getAffiliateCouponCode(): ?string
    {
     ...
     * @return $this
     */
    public function setAffiliateCouponCode(?string $affiliate_coupon_code): static
    {
     ...
     * @return int|null
     */
    public function getDefaultVatMode(): ?int
    {
     ...
     * @return $this
     */
    public function setDefaultVatMode(?int $default_vat_mode): static
    {
     ...
     * @return $this
     */
    public function setDefaultCurrency(?string $default_currency): static
    {
     ...
     * @return int|null
     */
    public function getDefaultVatIndex(): ?int
    {
     ...
     * @return $this
     */
    public function setDefaultVatIndex(?int $default_vat_index): static
    {
