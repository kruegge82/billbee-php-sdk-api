...
class BillbeeInterfacesBillbeeAPIModelOrderAddressApiModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Billbee.Interfaces.BillbeeAPI.Model.OrderAddressApiModel';
    ...
    */
     ...
     * @return $this
     */
    public function setNameAddition(?string $name_addition): static
    {
     ...
     * @return $this
     */
    public function setCountryIso2(?string $country_iso2): static
    {
