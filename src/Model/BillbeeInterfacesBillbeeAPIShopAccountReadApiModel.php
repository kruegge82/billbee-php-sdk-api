...
class BillbeeInterfacesBillbeeAPIShopAccountReadApiModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Billbee.Interfaces.BillbeeAPI.ShopAccountReadApiModel';
    ...
    */
     ...
     * @return $this
     */
    public function setLastSyncDate(?\DateTime $last_sync_date): static
    {
     ...
     * @return int|null
     */
    public function getLastSyncState(): ?int
    {
     ...
     * @return $this
     */
    public function setLastSyncState(?int $last_sync_state): static
    {
