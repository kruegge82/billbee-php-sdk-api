...
class BillbeeInterfacesBillbeeAPIModelOrder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Billbee.Interfaces.BillbeeAPI.Model.Order';
    ...
    */
     ...
     * @return $this
     */
    public function setRebateDifference(?float $rebate_difference): static
    {
     ...
     * @return $this
     */
    public function setShippingIds(?array $shipping_ids): static
    {
     ...
     * @return bool|null
     */
    public function getAcceptLossOfReturnRight(): ?bool
    {
     ...
     * @return $this
     */
    public function setAcceptLossOfReturnRight(?bool $accept_loss_of_return_right): static
    {
     ...
     * @return $this
     */
    public function setVatMode(?int $vat_mode): static
    {
        if (is_null($vat_mode)) {
     ...
     * @return $this
     */
    public function setConfirmedAt(?\DateTime $confirmed_at): static
    {
     ...
     * @return $this
     */
    public function setSellerComment(?string $seller_comment): static
    {
     ...
     * @return $this
     */
    public function setInvoiceNumberPrefix(?string $invoice_number_prefix): static
    {
     ...
     * @return $this
     */
    public function setInvoiceNumberPostfix(?string $invoice_number_postfix): static
    {
     ...
     */
    public function getInvoiceAddress(): ?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderAddressApiModel
    {
     ...
     * @return $this
     */
    public function setInvoiceAddress(?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderAddressApiModel $invoice_address): static
    {
     ...
     * @return \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderAddressApiModel|null
     */
    public function getShippingAddress(): ?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderAddressApiModel
    {
     ...
     * @return $this
     */
    public function setShippingAddress(?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderAddressApiModel $shipping_address): static
    {
     ...
     * @return $this
     */
    public function setAdjustmentCost(?float $adjustment_cost): static
    {
     ...
     * @return $this
     */
    public function setAdjustmentReason(?string $adjustment_reason): static
    {
     ...
     */
    public function getSeller(): ?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderUser
    {
     ...
     * @return $this
     */
    public function setSeller(?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderUser $seller): static
    {
        if (is_null($seller)) {
     ...
     * @return \kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderUser|null
     */
    public function getBuyer(): ?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderUser
    {
     ...
     * @return $this
     */
    public function setBuyer(?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelOrderUser $buyer): static
    {
        if (is_null($buyer)) {
     ...
     * @return $this
     */
    public function setTaxRate1(?float $tax_rate1): static
    {
     ...
     * @return $this
     */
    public function setTaxRate2(?float $tax_rate2): static
    {
     ...
     * @return int|null
     */
    public function getBillBeeOrderId(): ?int
    {
     ...
     * @return $this
     */
    public function setBillBeeOrderId(?int $bill_bee_order_id): static
    {
     ...
     * @return int|null
     */
    public function getBillBeeParentOrderId(): ?int
    {
     ...
     * @return $this
     */
    public function setBillBeeParentOrderId(?int $bill_bee_parent_order_id): static
    {
     ...
     * @return $this
     */
    public function setShipWeightKg(?float $ship_weight_kg): static
    {
     ...
     * @return $this
     */
    public function setShippingProfileId(?string $shipping_profile_id): static
    {
     ...
     * @return $this
     */
    public function setShippingProviderName(?string $shipping_provider_name): static
    {
     ...
     * @return $this
     */
    public function setShippingProviderProductName(?string $shipping_provider_product_name): static
    {
     ...
     * @return $this
     */
    public function setShippingProfileName(?string $shipping_profile_name): static
    {
     ...
     * @return $this
     */
    public function setPaymentInstruction(?string $payment_instruction): static
    {
     ...
     * @return string|null
     */
    public function getIsCancelationFor(): ?string
    {
     ...
     * @return $this
     */
    public function setIsCancelationFor(?string $is_cancelation_for): static
    {
     ...
     * @return $this
     */
    public function setDistributionCenter(?string $distribution_center): static
    {
     ...
     * @return $this
     */
    public function setDeliverySourceCountryCode(?string $delivery_source_country_code): static
    {
     ...
     * @return $this
     */
    public function setCustomInvoiceNote(?string $custom_invoice_note): static
    {
     ...
     */
    public function getCustomer(): ?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelCustomerApiModel
    {
     ...
     * @return $this
     */
    public function setCustomer(?\kruegge82\billbee\Model\BillbeeInterfacesBillbeeAPIModelCustomerApiModel $customer): static
    {
        if (is_null($customer)) {
     ...
     * @return $this
     */
    public function setLastModifiedAt(?\DateTime $last_modified_at): static
    {
     ...
     * @return $this
     */
    public function setArchivedAt(?\DateTime $archived_at): static
    {
     ...
     * @return \DateTime|null
     */
    public function getRestoredAt(): ?\DateTime
    {
     ...
     * @return $this
     */
    public function setRestoredAt(?\DateTime $restored_at): static
    {
     ...
     * @return $this
     */
    public function setMerchantVatId(?string $merchant_vat_id): static
    {
     ...
     * @return $this
     */
    public function setCustomerVatId(?string $customer_vat_id): static
    {
     ...
     * @return bool|null
     */
    public function getIsFromBillbeeApi(): ?bool
    {
     ...
     * @return $this
     */
    public function setIsFromBillbeeApi(?bool $is_from_billbee_api): static
    {
