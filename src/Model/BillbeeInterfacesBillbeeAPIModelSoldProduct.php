...
class BillbeeInterfacesBillbeeAPIModelSoldProduct implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Billbee.Interfaces.BillbeeAPI.Model.SoldProduct';
    ...
    */
     ...
     * @return $this
     */
    public function setSkuOrId(?string $sku_or_id): static
    {
     ...
     * @return string|null
     */
    public function getPlatformData(): ?string
    {
     ...
     * @return $this
     */
    public function setPlatformData(?string $platform_data): static
    {
     ...
     * @return $this
     */
    public function setTaricCode(?string $taric_code): static
    {
