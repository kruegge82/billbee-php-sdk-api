...
/**
 * BillbeeInterfacesBillbeeAPIModelGetReservedAmountResponseData Class Doc Comment
 *
 * @package  kruegge82\billbee
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BillbeeInterfacesBillbeeAPIModelGetReservedAmountResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Billbee.Interfaces.BillbeeAPI.Model.GetReservedAmountResponseData';
    ...
    */
     ...
     *
     * @param float|null $reserved_amount The reserve (not fulfilled) qty of the article
     *
     * @return $this
     */
    public function setReservedAmount(?float $reserved_amount): static
    {
