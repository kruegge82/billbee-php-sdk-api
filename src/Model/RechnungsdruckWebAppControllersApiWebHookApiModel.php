...
class RechnungsdruckWebAppControllersApiWebHookApiModel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Rechnungsdruck.WebApp.Controllers.Api.WebHookApiModel';
    ...
    */
     ...
     * @return $this
     */
    public function setWebHookUri(string $web_hook_uri): static
    {
